...
export const fetchAllQuestions = async (username) => {
    const response = await api.get(`/questions/all/with-progress?username=${username}`);
    return response.data;
};
...
// Add this to lib/api.js
export const fetchCurrentAssessment = async () => {
